...
import worldbuilder.generation as geo
from worldbuilder.common import set_verbose, print_verbose, get_verbose
from worldbuilder.draw import draw_ancientmap_on_file, draw_biome_on_file, draw_ocean_on_file, \
...
from worldbuilder.imex import export

from worldbuilder.model.world import World, Size, GenerationParameters
from worldbuilder.plates import world_gen, generate_plates_simulation
from worldbuilder.step import Step
from worldbuilder.version import __version__

try:
    from worldbuilder.hdf5_serialization import save_world_to_hdf5
...
def __seems_protobuf_worldfile__(world_filename):
    worldbuilder_tag = __get_tag__(world_filename)
    return worldbuilder_tag == World.worldbuilder_tag()
...
def main():
    ...
    print('Worldbuilder - a world generator (v. %s)' % VERSION)
    print('-----------------------')
...
def usage(error=None):
    print(
        ' -------------------------------------------------------------------')
    print(' Sylvester Duda, 2020-2025?')
    print(' Worldbuilder - a world generator (v. %s)' % VERSION)
    print(' ')
    print(' worldbuilder <world_name> [operation] [options]')
